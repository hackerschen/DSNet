...
class BiSeNetV1(nn.Module):
    ...
    def __init__(self, n_classes, criterion,aux_mode='train', *args, **kwargs):
    ...
    def forward(self, x, gt=None):
        ...
        if gt is not None:
            ...
            loss = self.criterion(feat_out, gt)
            loss += self.criterion(feat_out16, gt)
            loss += self.criterion(feat_out32, gt)
