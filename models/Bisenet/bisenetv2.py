...
class BiSeNetV2(nn.Module):
    ...
    def __init__(self, n_classes, criterion):
    ...
    def forward(self, x, gt=None):
        ...
        if gt is not None:
            ...
            loss += self.criterion(logits_aux2, gt)
            loss += self.criterion(logits_aux3, gt)
            loss += self.criterion(logits_aux4, gt)
            loss += self.criterion(logits_aux5_4, gt)
