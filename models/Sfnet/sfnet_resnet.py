...
from models.Sfnet.bialign import AlignedModule
from models.Sfnet.nn.mynn import Upsample, Norm2d
from models.Sfnet.nn.operators import PSPModule, SPSPModule, AlignedModulev2PoolingAtten, AlignedModulev2
from models.Sfnet import resnet_d as Resnet_Deep
...
class AlignNetResNet(nn.Module):
    ...
    def forward(self, x, gts=None):
        ...
        if gts is not None:
            return self.criterion(main_out, gts), main_out
        return main_out
