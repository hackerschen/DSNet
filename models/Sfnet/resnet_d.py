...
from models.Sfnet.nn import mynn
...
def resnet18(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("/data/cj_jasper/pretrained/resnet18-deep-inplane128.pth", map_location="cpu"))
    return model
...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("/data/cj/pretrained/resnet50-deep.pth", map_location='cpu'))
    return model
