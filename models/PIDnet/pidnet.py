...
from models.PIDnet.model_utils import BasicBlock, PagFM, Bottleneck, PAPPM, Light_Bag, DAPPM, Bag, segmenthead
...
class PIDNet(nn.Module):
    ...
    def __init__(self, m=1, n=3, num_classes=19, planes=64, ppm_planes=96, head_planes=128, augment=True):
